...
if not TIGERBOT:get(TIGER_ID..'lock:reoly:bot'..msg.chat_id_) then
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1,taha8[math.random(#taha8)], 1, 'html') 
end
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1,taha9[math.random(#taha9)], 1, 'html') 
end
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1,taha10[math.random(#taha10)], 1, 'html') 
end
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md')
end 
...
'هـايـات يـروحـي┋🌸', 
'يههلا بيك حياتي 💛🌿'}      TIGER_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md')   
end
...
'ﯛ୭ﯠ۶ـہٰٰٰٖٖٖلہٰٰٰٖٖٖيکگہٰٰٰٖٖٖمہٰٰٰٖٖٖہ ٵٴلہٰٰٰٖٖٖسہلہٰٰٰٖٖٖاٴمہٰٰٰٖٖٖہ ┆ ➰✌️🏿'}  TIGER_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md') 
end 
...
if text =="🌚" then 
taha =   "• فـﮧديت صخـﮧامك🙊👄" 
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text == "🌚🌚" then 
taha =   "• فـﮧديت صخـﮧامك🙊👄" 
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
...
if text =="شبيكم" then 
taha =   "مبينه شي سلامتك/ ج🎈😌"   TIGER_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text =="شبيكك" then 
taha =   "مبينه شي سلامتك/ ج🎈😌" 
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
...
if TIGERBOT:get(TIGER_ID..'lock:reoly:bot'..msg.chat_id_) then
taha = '*☑ ※ تم تفعيل ردود البوت *\n✓' 
TIGER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
TIGERBOT:del(TIGER_ID..'lock:reoly:bot'..msg.chat_id_) 
else
...
TIGER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
TIGERBOT:set(TIGER_ID..'lock:reoly:bot'..msg.chat_id_,true) 
else
...
local delac = [[*
📓 ※ رابط حذف حـساب التلجرام
🃏 ※ احذف ورتاح ولا تتندم ...
🗞※ بالتـوفيـق عزيزي ...*
📜※ [اضغط هنا لحذف حسابك](https://telegram.org/deactivate)
]]
TIGER_sendMsg(msg.chat_id_, msg.id_, 1,delac, 1, 'md')
 end

if MSG_TEXT[1] == 'الاوامر' then
if not is_mod(msg) then 
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن الادمنيه 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
※ source ᴏɴᴇ ɪɴ ɪʀᴀǫ 🔱 »
...
※ هناك  (8)اوامر لعرضها ⚙️

♦️➖▪️➖▪️➖▪️➖▪️➖♦️

※ م1 ☰ لعرض اوامر الحمايه 🗑

※ م2☰ لعرض اوامر الاعضاء 👨🏼‍✈️

※ م3 ☰ لعرض قائمه الحظر و الخ..  🚫

※ م4☰ لعرض قائمه الادمنيه  📜

※ م5☰ لعرض اوامر المدراء  👨🏻‍⚖️
...
※ م9 ☰ لعرض اوامر الصلاحيه لتحديد صلاحيات الادمنيه والمدراء 📋

♦️➖▪️➖▪️➖▪️➖▪️➖♦️

🔖 ※ للاستفسار او حدوث مشكلة ✓ 
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن المدراء 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
🔖 ※ في اوامــر المدراء 
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن المنشئين 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
🔖 ※ في اوامــر المنڜئين'
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن المطورين 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
...
TIGER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست المطور الاساسي 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
